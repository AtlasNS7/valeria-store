...
export function GirlfriendGiftBanner() {
  return (
    <section className="bg-[var(--plum)] text-white">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-6 sm:py-7 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-white text-[var(--plum)] font-semibold rounded-full px-6 py-2.5 hover:bg-[var(--gold)] hover:text-[var(--night)] transition-colors whitespace-nowrap"
        >
